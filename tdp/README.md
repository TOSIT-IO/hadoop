...
The version 3.4.1-1.0 of Apache Hadoop is based on the `rel/release-3.4.1` tag of the Apache [repository](https://github.com/apache/hadoop/tree/rel/release-3.4.1).
