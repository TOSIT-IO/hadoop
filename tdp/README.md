...
The version 3.4.2-1.0 of Apache Hadoop is based on the `rel/release-3.4.2` tag of the Apache [repository](https://github.com/apache/hadoop/tree/rel/release-3.4.2).
...
`-Pdist -Dtar` generates a `.tar.gz` file of the release at `./hadoop-dist/target/hadoop-3.4.2-1.0.tar.gz`.
